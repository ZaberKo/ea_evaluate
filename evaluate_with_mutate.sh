...
do
    ...
    python evaluate_with_mutate.py ${checkpoint_path} --run ref.impala.ImpalaTrainer --episodes 1000 --config evaluate.yml --out eval_result_hard_20_15_without_conv/mutate_result_${iter}.pkl
done